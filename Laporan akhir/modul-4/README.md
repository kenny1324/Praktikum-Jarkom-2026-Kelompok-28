...
- Router terhubung ke internet melalui Ether1.
- PC A berada pada jaringan VLAN 10.
- PC B berada pada jaringan VLAN 20.
- NAT digunakan agar seluruh host dapat mengakses internet.
...
|----------|----------|----------|----------|
| Router | Ether1 | DHCP Client | Internet |
| Router | Ether2 | 10.10.10.1/24 | VLAN 10 |
| Router | Ether3 | 10.20.20.1/24 | VLAN 20 |
| PC A | NIC | 10.10.10.10/24 | DHCP |
| PC B | NIC | 10.20.20.10/24 | DHCP |
